...
function! bbye#delete(action, bang, buffer_name, ...)
    if a:0 == 0
        let l:mods = ""
    else
        let l:mods = a:1
...
command! -bang -complete=buffer -nargs=?
                      \ BufferClose            call bbye#delete('bdelete', <q-bang>, <q-args>, <q-mods>)
command! -bang -complete=buffer -nargs=?
                      \ BufferDelete           call bbye#delete('bdelete', <q-bang>, <q-args>, <q-mods>)
command! -bang -complete=buffer -nargs=?
                      \ BufferWipeout          call bbye#delete('bwipeout', <q-bang>, <q-args>, <q-mods>)
