...
local theme = require("themes." .. g.nv_theme)
...
-- Vim editor colors
highlight("Normal", theme.base05, nil, nil, nil)
...
highlight("VertSplit", theme.base0D, "NONE", "none", nil)
...
-- nvim-cmp
highlight("CmpItemAbbrMatch", theme.base0C, nil, nil, nil)
